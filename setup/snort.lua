...
include '/snort/etc/snort/snort_defaults.lua'
...
ips =
{
    ...
    rules = [[
        include /snort/rules/et_snort3_all.rules
        include /snort/rules/snort3-community.rules
    ]],
...
-- if no tweaks are specified, use the security tweaks by default

if ( tweaks ~= nil ) then
    include('/snort/etc/snort/' .. tweaks .. '.lua')
else
    include '/snort/etc/snort/security.lua'
end

---------------------------------------------------------------------------
-- 9. Import custom rules
---------------------------------------------------------------------------

include '/snort/etc/snort/et_thresholds.lua'
